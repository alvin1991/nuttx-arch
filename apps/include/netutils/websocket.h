...
#define WEBSOCKET_DEBUG nwarn
#else
#define WEBSOCKET_DEBUG(...) do { } while (0)
#endif

#define WEBSOCKET_WARN_PRINT
/**< websocket debug print option if defined, enables debug print */
#if defined(WEBSOCKET_WARN_PRINT)
#define WEBSOCKET_WARN nwarn
#else
#define WEBSOCKET_WARN(...) do { } while (0)
#endif

#define WEBSOCKET_ERR_PRINT
/**< websocket debug print option if defined, enables debug print */
#if defined(WEBSOCKET_DEBUG_PRINT)
#define WEBSOCKET_ERR nerr
#else
#define WEBSOCKET_ERR(...) do { } while (0)
#endif
 ...
 */
#define WEBSOCKET_SERVER_TIMEOUT                     (21600 * 60 * 1000)	//mili second(15 days)
 ...
 */
#define WEBSOCKET_PING_INTERVAL                      (10 * 100)	//MSEC_PER_TICK
...
/**
 * @brief websocket_get_live_table() returns amount of working websocket server bit mask.
 * @param[in] none.
 * @return return amount of working websocket server
 * @since TizenRT v1.0
 */
