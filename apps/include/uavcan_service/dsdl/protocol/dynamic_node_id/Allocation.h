...
#ifndef __DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION
#define __DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION
...
dsdl.uavcan.protocol.dynamic_node_id.Allocation
saturated uint7 node_id
saturated bool first_part_of_unique_id
saturated uint8[<=16] unique_id
******************************************************************************/

#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_ID 1
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_NAME "dsdl.uavcan.protocol.dynamic_node_id.Allocation"
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_SIGNATURE (0x4D6085B7B482EFF2ULL)

#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_MAX_SIZE ((141 + 7)/8)

// Constants
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_MAX_REQUEST_PERIOD_MS       1000 // 1000
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_MIN_REQUEST_PERIOD_MS        600 // 600
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_MAX_FOLLOWUP_DELAY_MS        400 // 400
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_MIN_FOLLOWUP_DELAY_MS          0 // 0
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_FOLLOWUP_TIMEOUT_MS        500 // 500
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_MAX_LENGTH_OF_UNIQUE_ID_IN_REQUEST          6 // 6
#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_ANY_NODE_ID           0 // 0

#define DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION_UNIQUE_ID_MAX_LENGTH             16
...
} dsdl_uavcan_protocol_dynamic_node_id_Allocation;

static inline
uint32_t dsdl_uavcan_protocol_dynamic_node_id_Allocation_encode(dsdl_uavcan_protocol_dynamic_node_id_Allocation* source, void* msg_buf);

static inline
int32_t dsdl_uavcan_protocol_dynamic_node_id_Allocation_decode(const CanardRxTransfer* transfer, uint16_t payload_len, dsdl_uavcan_protocol_dynamic_node_id_Allocation* dest, uint8_t** dyn_arr_buf);

static inline
uint32_t dsdl_uavcan_protocol_dynamic_node_id_Allocation_encode_internal(dsdl_uavcan_protocol_dynamic_node_id_Allocation* source, void* msg_buf, uint32_t offset, uint8_t root_item);

static inline
int32_t dsdl_uavcan_protocol_dynamic_node_id_Allocation_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, dsdl_uavcan_protocol_dynamic_node_id_Allocation* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao);
...
/**
  * @brief dsdl_uavcan_protocol_dynamic_node_id_Allocation_encode_internal
  ...
  */
uint32_t dsdl_uavcan_protocol_dynamic_node_id_Allocation_encode_internal(dsdl_uavcan_protocol_dynamic_node_id_Allocation* source,
  void* msg_buf,
  uint32_t offset,
...
/**
  * @brief dsdl_uavcan_protocol_dynamic_node_id_Allocation_encode
  * @param source : Pointer to source data struct
  * @param msg_buf: Pointer to msg storage
...
uint32_t dsdl_uavcan_protocol_dynamic_node_id_Allocation_encode(dsdl_uavcan_protocol_dynamic_node_id_Allocation* source, void* msg_buf)
{
    ...
    offset = dsdl_uavcan_protocol_dynamic_node_id_Allocation_encode_internal(source, msg_buf, offset, 1);

    return (offset + 7 ) / 8;
}

/**
  * @brief dsdl_uavcan_protocol_dynamic_node_id_Allocation_decode_internal
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  *                     dsdl_uavcan_protocol_dynamic_node_id_Allocation dyn memory will point to dyn_arr_buf memory.
  *                     NULL will ignore dynamic arrays decoding.
  * @param offset: Call with 0, bit offset to msg storage
  * @param tao: is tail array optimization used
  * @retval offset or ERROR value if < 0
  */
int32_t dsdl_uavcan_protocol_dynamic_node_id_Allocation_decode_internal(
  const CanardRxTransfer* transfer,
  uint16_t CANARD_MAYBE_UNUSED(payload_len),
  dsdl_uavcan_protocol_dynamic_node_id_Allocation* dest,
  ...
  uint8_t CANARD_MAYBE_UNUSED(tao))
{
    ...
    if (ret != 7)
    {
        goto dsdl_uavcan_protocol_dynamic_node_id_Allocation_error_exit;
    }
    offset += 7;
...
dsdl_uavcan_protocol_dynamic_node_id_Allocation_error_exit:
    if (ret < 0)
    {
        return ret;
    }
...
/**
  * @brief dsdl_uavcan_protocol_dynamic_node_id_Allocation_decode
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t dsdl_uavcan_protocol_dynamic_node_id_Allocation_decode(const CanardRxTransfer* transfer,
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        for (uint32_t c = 0; c < sizeof(dsdl_uavcan_protocol_dynamic_node_id_Allocation); c++)
        {
            ((uint8_t*)dest)[c] = 0x00;
        }

        ret = dsdl_uavcan_protocol_dynamic_node_id_Allocation_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
...
#endif
#endif // __DSDL_UAVCAN_PROTOCOL_DYNAMIC_NODE_ID_ALLOCATION