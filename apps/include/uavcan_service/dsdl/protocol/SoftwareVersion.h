...
#ifndef __DSDL_UAVCAN_PROTOCOL_SOFTWAREVERSION
#define __DSDL_UAVCAN_PROTOCOL_SOFTWAREVERSION
...
dsdl.uavcan.protocol.SoftwareVersion
...
#define DSDL_UAVCAN_PROTOCOL_SOFTWAREVERSION_NAME          "dsdl.uavcan.protocol.SoftwareVersion"
#define DSDL_UAVCAN_PROTOCOL_SOFTWAREVERSION_SIGNATURE     (0xE333119C31D02E23ULL)

#define DSDL_UAVCAN_PROTOCOL_SOFTWAREVERSION_MAX_SIZE      ((120 + 7)/8)

// Constants
#define DSDL_UAVCAN_PROTOCOL_SOFTWAREVERSION_OPTIONAL_FIELD_FLAG_VCS_COMMIT          1 // 1
#define DSDL_UAVCAN_PROTOCOL_SOFTWAREVERSION_OPTIONAL_FIELD_FLAG_IMAGE_CRC          2 // 2
...
} dsdl_uavcan_protocol_SoftwareVersion;

static inline
uint32_t dsdl_uavcan_protocol_SoftwareVersion_encode(dsdl_uavcan_protocol_SoftwareVersion* source, void* msg_buf);

static inline
int32_t dsdl_uavcan_protocol_SoftwareVersion_decode(const CanardRxTransfer* transfer, uint16_t payload_len, dsdl_uavcan_protocol_SoftwareVersion* dest, uint8_t** dyn_arr_buf);

static inline
uint32_t dsdl_uavcan_protocol_SoftwareVersion_encode_internal(dsdl_uavcan_protocol_SoftwareVersion* source, void* msg_buf, uint32_t offset, uint8_t root_item);

static inline
int32_t dsdl_uavcan_protocol_SoftwareVersion_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, dsdl_uavcan_protocol_SoftwareVersion* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao);
...
/**
  * @brief dsdl_uavcan_protocol_SoftwareVersion_encode_internal
  ...
  */
uint32_t dsdl_uavcan_protocol_SoftwareVersion_encode_internal(dsdl_uavcan_protocol_SoftwareVersion* source,
  void* msg_buf,
  uint32_t offset,
...
/**
  * @brief dsdl_uavcan_protocol_SoftwareVersion_encode
  * @param source : Pointer to source data struct
  * @param msg_buf: Pointer to msg storage
...
uint32_t dsdl_uavcan_protocol_SoftwareVersion_encode(dsdl_uavcan_protocol_SoftwareVersion* source, void* msg_buf)
{
    ...
    offset = dsdl_uavcan_protocol_SoftwareVersion_encode_internal(source, msg_buf, offset, 1);

    return (offset + 7 ) / 8;
}

/**
  * @brief dsdl_uavcan_protocol_SoftwareVersion_decode_internal
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  *                     dsdl_uavcan_protocol_SoftwareVersion dyn memory will point to dyn_arr_buf memory.
  *                     NULL will ignore dynamic arrays decoding.
  * @param offset: Call with 0, bit offset to msg storage
  * @param tao: is tail array optimization used
  * @retval offset or ERROR value if < 0
  */
int32_t dsdl_uavcan_protocol_SoftwareVersion_decode_internal(
  const CanardRxTransfer* transfer,
  uint16_t CANARD_MAYBE_UNUSED(payload_len),
  dsdl_uavcan_protocol_SoftwareVersion* dest,
  ...
  uint8_t CANARD_MAYBE_UNUSED(tao))
{
    ...
    if (ret != 8)
    {
        goto dsdl_uavcan_protocol_SoftwareVersion_error_exit;
    }
    offset += 8;
...
dsdl_uavcan_protocol_SoftwareVersion_error_exit:
    if (ret < 0)
    {
        return ret;
    }
...
/**
  * @brief dsdl_uavcan_protocol_SoftwareVersion_decode
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t dsdl_uavcan_protocol_SoftwareVersion_decode(const CanardRxTransfer* transfer,
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        for (uint32_t c = 0; c < sizeof(dsdl_uavcan_protocol_SoftwareVersion); c++)
        {
            ((uint8_t*)dest)[c] = 0x00;
        }

        ret = dsdl_uavcan_protocol_SoftwareVersion_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
...
#endif
#endif // __DSDL_UAVCAN_PROTOCOL_SOFTWAREVERSION