...
#ifndef __DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA
#define __DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA
...
dsdl.uavcan.equipment.air_data.RawAirData
...
#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_ID       1027
#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_NAME     "dsdl.uavcan.equipment.air_data.RawAirData"
#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_SIGNATURE (0xCEE80B05B90D7D41ULL)

#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_MAX_SIZE ((397 + 7)/8)

// Constants
#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_FLAG_HEATER_AVAILABLE          1 // 1
#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_FLAG_HEATER_WORKING          2 // 2
#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_FLAG_HEATER_OVERCURRENT          4 // 4
#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_FLAG_HEATER_OPENCIRCUIT          8 // 8

#define DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA_COVARIANCE_MAX_LENGTH                  16
...
} dsdl_uavcan_equipment_air_data_RawAirData;

static inline
uint32_t dsdl_uavcan_equipment_air_data_RawAirData_encode(dsdl_uavcan_equipment_air_data_RawAirData* source, void* msg_buf);

static inline
int32_t dsdl_uavcan_equipment_air_data_RawAirData_decode(const CanardRxTransfer* transfer, uint16_t payload_len, dsdl_uavcan_equipment_air_data_RawAirData* dest, uint8_t** dyn_arr_buf);

static inline
uint32_t dsdl_uavcan_equipment_air_data_RawAirData_encode_internal(dsdl_uavcan_equipment_air_data_RawAirData* source, void* msg_buf, uint32_t offset, uint8_t root_item);

static inline
int32_t dsdl_uavcan_equipment_air_data_RawAirData_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, dsdl_uavcan_equipment_air_data_RawAirData* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao);
...
/**
  * @brief dsdl_uavcan_equipment_air_data_RawAirData_encode_internal
  ...
  */
uint32_t dsdl_uavcan_equipment_air_data_RawAirData_encode_internal(dsdl_uavcan_equipment_air_data_RawAirData* source,
  void* msg_buf,
  uint32_t offset,
...
/**
  * @brief dsdl_uavcan_equipment_air_data_RawAirData_encode
  * @param source : Pointer to source data struct
  * @param msg_buf: Pointer to msg storage
...
uint32_t dsdl_uavcan_equipment_air_data_RawAirData_encode(dsdl_uavcan_equipment_air_data_RawAirData* source, void* msg_buf)
{
    ...
    offset = dsdl_uavcan_equipment_air_data_RawAirData_encode_internal(source, msg_buf, offset, 1);

    return (offset + 7 ) / 8;
}

/**
  * @brief dsdl_uavcan_equipment_air_data_RawAirData_decode_internal
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  *                     dsdl_uavcan_equipment_air_data_RawAirData dyn memory will point to dyn_arr_buf memory.
  *                     NULL will ignore dynamic arrays decoding.
  * @param offset: Call with 0, bit offset to msg storage
  * @param tao: is tail array optimization used
  * @retval offset or ERROR value if < 0
  */
int32_t dsdl_uavcan_equipment_air_data_RawAirData_decode_internal(
  const CanardRxTransfer* transfer,
  uint16_t CANARD_MAYBE_UNUSED(payload_len),
  dsdl_uavcan_equipment_air_data_RawAirData* dest,
  ...
  uint8_t CANARD_MAYBE_UNUSED(tao))
{
    ...
    if (ret != 8)
    {
        goto dsdl_uavcan_equipment_air_data_RawAirData_error_exit;
    }
    offset += 8;
...
dsdl_uavcan_equipment_air_data_RawAirData_error_exit:
    if (ret < 0)
    {
        return ret;
    }
...
/**
  * @brief dsdl_uavcan_equipment_air_data_RawAirData_decode
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t dsdl_uavcan_equipment_air_data_RawAirData_decode(const CanardRxTransfer* transfer,
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        for (uint32_t c = 0; c < sizeof(dsdl_uavcan_equipment_air_data_RawAirData); c++)
        {
            ((uint8_t*)dest)[c] = 0x00;
        }

        ret = dsdl_uavcan_equipment_air_data_RawAirData_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
...
#endif
#endif // __DSDL_UAVCAN_EQUIPMENT_AIR_DATA_RAWAIRDATA