...
#ifndef __DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO
#define __DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO
...
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_ID         1092
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_NAME       "dsdl.uavcan.equipment.power.BatteryInfo"
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_SIGNATURE  (0xF3BA550BDC3BA4CULL)

#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_MAX_SIZE   ((437 + 7)/8)

// Constants
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_IN_USE            1 // 1
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_CHARGING          2 // 2
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_CHARGED           4 // 4
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_TEMP_HOT          8 // 8
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_TEMP_COLD         16 // 16
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_OVERLOAD         32 // 32
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_BAD_BATTERY         64 // 64
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_NEED_SERVICE        128 // 128
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_BMS_ERROR        256 // 256
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_RESERVED_A        512 // 512
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATUS_FLAG_RESERVED_B       1024 // 1024
#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_STATE_OF_HEALTH_UNKNOWN        127 // 127

#define DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO_MODEL_NAME_MAX_LENGTH                    31
...
} dsdl_uavcan_equipment_power_BatteryInfo;

static inline
uint32_t dsdl_uavcan_equipment_power_BatteryInfo_encode(dsdl_uavcan_equipment_power_BatteryInfo* source, void* msg_buf);

static inline
int32_t dsdl_uavcan_equipment_power_BatteryInfo_decode(const CanardRxTransfer* transfer, uint16_t payload_len, dsdl_uavcan_equipment_power_BatteryInfo* dest, uint8_t** dyn_arr_buf);

static inline
uint32_t dsdl_uavcan_equipment_power_BatteryInfo_encode_internal(dsdl_uavcan_equipment_power_BatteryInfo* source, void* msg_buf, uint32_t offset, uint8_t root_item);

static inline
int32_t dsdl_uavcan_equipment_power_BatteryInfo_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, dsdl_uavcan_equipment_power_BatteryInfo* dest, uint8_t** dyn_arr_buf, int32_t offset, uint8_t tao);
...
/**
  * @brief dsdl_uavcan_equipment_power_BatteryInfo_encode_internal
  ...
  */
uint32_t dsdl_uavcan_equipment_power_BatteryInfo_encode_internal(dsdl_uavcan_equipment_power_BatteryInfo* source,
  void* msg_buf,
  uint32_t offset,
...
/**
  * @brief dsdl_uavcan_equipment_power_BatteryInfo_encode
  * @param source : Pointer to source data struct
  * @param msg_buf: Pointer to msg storage
...
uint32_t dsdl_uavcan_equipment_power_BatteryInfo_encode(dsdl_uavcan_equipment_power_BatteryInfo* source, void* msg_buf)
{
    ...
    offset = dsdl_uavcan_equipment_power_BatteryInfo_encode_internal(source, msg_buf, offset, 1);

    return (offset + 7 ) / 8;
}

/**
  * @brief dsdl_uavcan_equipment_power_BatteryInfo_decode_internal
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  *                     dsdl_uavcan_equipment_power_BatteryInfo dyn memory will point to dyn_arr_buf memory.
  *                     NULL will ignore dynamic arrays decoding.
  * @param offset: Call with 0, bit offset to msg storage
  * @param tao: is tail array optimization used
  * @retval offset or ERROR value if < 0
  */
int32_t dsdl_uavcan_equipment_power_BatteryInfo_decode_internal(
  const CanardRxTransfer* transfer,
  uint16_t CANARD_MAYBE_UNUSED(payload_len),
  dsdl_uavcan_equipment_power_BatteryInfo* dest,
  ...
  uint8_t CANARD_MAYBE_UNUSED(tao))
{
    ...
    if (ret != 16)
    {
        goto dsdl_uavcan_equipment_power_BatteryInfo_error_exit;
    }
#ifndef CANARD_USE_FLOAT16_CAST
...
dsdl_uavcan_equipment_power_BatteryInfo_error_exit:
    if (ret < 0)
    {
        return ret;
    }
...
/**
  * @brief dsdl_uavcan_equipment_power_BatteryInfo_decode
  * @param transfer: Pointer to CanardRxTransfer transfer
  * @param payload_len: Payload message length
  * @param dest: Pointer to destination struct
  * @param dyn_arr_buf: NULL or Pointer to memory storage to be used for dynamic arrays
  ...
  * @retval offset or ERROR value if < 0
  */
int32_t dsdl_uavcan_equipment_power_BatteryInfo_decode(const CanardRxTransfer* transfer,
  ...
  uint8_t** dyn_arr_buf)
{
    ...
    while (1)
    {
        ...
        for (uint32_t c = 0; c < sizeof(dsdl_uavcan_equipment_power_BatteryInfo); c++)
        {
            ((uint8_t*)dest)[c] = 0x00;
        }

        ret = dsdl_uavcan_equipment_power_BatteryInfo_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao);
...
#endif
#endif // __DSDL_UAVCAN_EQUIPMENT_POWER_BATTERYINFO