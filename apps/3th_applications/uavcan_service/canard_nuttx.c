...
/****************************************************************************
 * Name: canardNuttXInit
 *
 * Description:
 *   Initialize can interface.
 *
 * Input Parameters:
 *   out_ins  - libuavard nuttx Instance
 *   can_iface_name - device name in nuttx. eg./dev/can0
 *
 * Returned Value:
 *   none.
 *
...
/****************************************************************************
 * Name: canardNuttXTransmit
 *
 * Description:
 *   Transmit a frame in timeout_msec.
 *
 * Input Parameters:
 *   out_ins  - libuavard nuttx Instance
 *   frame  - data frame
 *   timeout_msec - limit time for transmit
 *
 * Returned Value:
 *   result of transmit.
 *
...
/****************************************************************************
 * Name: canardNuttXReceive
 *
 * Description:
 *   receive a frame in timeout_msec.
 *
 * Input Parameters:
 *   out_ins  - libuavard nuttx Instance
...
/****************************************************************************
 * Name: canardNuttXGetDeviceFileDescriptor
 *
 * Description:
 *   get libuavard nuttx Device FileDescriptor.
 *
 * Input Parameters:
 *   out_ins  - libuavard nuttx Instance.
 *
